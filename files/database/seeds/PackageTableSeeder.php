        ...
        $sites = [
            1 => [
                'normal_1' => [
                    ...
                    'fromName'   => 'From name',
                    'subject' => 'subject',
                    'template' => '<p><font face="Times New Roman">{{section TIP}}</font></p><p><font face="Times New Roman">Welcome {{email}}</font></p><p><font face="Times New Roman">{{date}} &nbsp;{{coountry}}: {{league}}<br>{{homeTeam}} - {{awayTeam}}</font></p><p><font face="Times New Roman">Bet: {{prediction}}</font></p><p><font face="Times New Roman">{{/section TIP}}<br>{{section NOTIP}}</font></p><p><font face="Times New Roman">Welcome {{email}}</font></p><p><font face="Times New Roman">There is no profitable tip for today, so will wait till tomorow.</font></p><p><font face="Times New Roman">{{/section NO TIP}}</font></p><p><span style="font-family: &quot;Times New Roman&quot;;">Have a good day!</span><br style="font-family: &quot;Times New Roman&quot;;"><span style="font-family: &quot;Times New Roman&quot;;">\'\'\' ``` "" ----------- ___ \\\?????////////</span><font face="Times New Roman"><br></font></p>1"',
                ],
                'normal_2' => [
                    'name' => '30 Tips',
                    'identifier' => 'normal_2',
